...
echo "    INCLUDE_LANG_TOKS=$INCLUDE_LANG_TOKS"
echo "    INCLUDE_PAD_TOK=$INCLUDE_PAD_TOK"
echo "    SPECIAL_TOKS=$SPECIAL_TOKS"
echo "    IS_ATT=$IS_ATT"
echo "-------------------------------"
...
echo "Created by Pipeline/train_tokenizer.sh ${config_file}" > ${TOK_TRAIN_DATA_DIR}/notes
