...
ancestors = {
    ...
    ######## ADDED LANGUAGES ########
    "an": ['ine-pro', 'itc-pro', 'itc-ola', 'la', 'lat-vul'], # I'll assume Spanish and Aragonese have the same ancestors except Old Spanish.
    "mfe": ['ine-pro', 'itc-pro', 'itc-ola', 'la', 'lat-vul', 'ofr', 'frm', 'fr'], # same as FRENCH CREOLES
